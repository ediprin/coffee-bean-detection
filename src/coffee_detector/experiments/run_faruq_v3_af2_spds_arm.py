...
from coffee_detector.af2_spds import AF2SPDSConfig, ARMS, make_af2_spds_trainer
...
def run_faruq_v3_af2_spds_arm(
    ...
    *,
    ...
    if seed != 42:
        raise ValueError("Screening AF2-SPDS dikunci pada seed 42")
    ...
    if audit.get("format") != "coffee_detector.af2_spds.static_audit.v1":
        raise RuntimeError("Static audit AF2-SPDS tidak sesuai schema")
    ...
    result = {
        "format": "coffee_detector.af2_spds.arm_result.v1",
        "protocol": "faruq-v3-af2-spds-seed42-v1",
        "arm": arm,
        "seed": seed,
        "target": spds.target,
        "metrics": metrics,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train one matched AF2-SPDS arm")
