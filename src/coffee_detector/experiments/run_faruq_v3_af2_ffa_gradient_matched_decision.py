"""Decision for the gradient-matched bounded AF2 feature-frequency adapter."""
...
def run_faruq_v3_af2_ffa_gradient_matched_decision(
    control_result: str | Path,
    unbounded_result: str | Path,
    matched_bounded_result: str | Path,
    output: str | Path,
) -> dict:
    reports = {
        "AF2FFA0": _read(control_result, "AF2FFA0"),
        "AF2FFA1": _read(unbounded_result, "AF2FFA1"),
        "AF2FFAB2": _read(matched_bounded_result, "AF2FFAB2"),
    }
    source_hashes = {
    ...
    versus_control = _delta(values["AF2FFAB2"], values["AF2FFA0"])
    versus_unbounded = _delta(values["AF2FFAB2"], values["AF2FFA1"])
    criteria = {
    ...
    payload = {
        "format": "coffee_detector.af2_ffa.gradient_matched_seed42_decision.v1",
        "seed": 42,
        "values": values,
        "matched_bounded_minus_control": versus_control,
        "matched_bounded_minus_unbounded": versus_unbounded,
        "criteria": criteria,
        "decision": decision,
        "next": (
        ...
        "training_executed_for_this_study": ["AF2FFAB2"],
        "invalid_historical_arm_excluded_from_comparison": "AF2FFAB1",
        "test_opened": False,
    }
