...
class AF2LuminanceDetectionModel(DetectionModel):
    """Native YOLO26 with the parameter-free luminance-shared AF2 frontend."""
    ...
    def __init__(self, cfg="yolo26.yaml", ch=3, nc=None, verbose=True, afab=None):
        ...
        self.af2_luminance = AF2LuminanceInputEnhancer(frozen)
...
def load_af2_luminance_weights(model: nn.Module, weights: Any) -> dict[str, int]:
    """Load native weights while preserving the parameter-free frontend."""
