...
Data uji baru digunakan setelah \(C^*\), aturan pemilihan model, metrik, dan prosedur evaluasi akhir ditetapkan. Tidak dilakukan perubahan metode atau parameter berdasarkan hasil data uji.
