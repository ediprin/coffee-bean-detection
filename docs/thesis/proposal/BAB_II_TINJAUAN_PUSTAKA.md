...
| 11 | Syauqi et al. (2025) | IEEE Conference | Deteksi cacat white pepper | CLAHE-based composite preprocessing + YOLOv8m | Memberikan contoh penerapan fixed preprocessing sebelum detector pada objek pertanian berbentuk biji. |
