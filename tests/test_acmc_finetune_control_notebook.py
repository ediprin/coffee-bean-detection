...
NOTEBOOK = Path(__file__).parents[1] / "notebooks/Faruq_V3_ACMC_Optimization_Control_Colab.ipynb"


def test_d0ft_control_notebook_is_resumable_and_test_locked() -> None:
    ...
    assert "D0FT_seed42/weights/last.pt" in source
