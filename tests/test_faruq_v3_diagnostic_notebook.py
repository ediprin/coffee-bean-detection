...
NOTEBOOK = Path(__file__).parents[1] / "notebooks" / "Faruq_V3_Diagnostic_Colab.ipynb"


def test_faruq_diagnostic_notebook_is_validation_only_and_training_free() -> None:
    ...
    assert "faruq_v3_diagnostics" in source
